...
class AnnoncesController extends AbstractController
{
    ...
    public function index(AnnoncesRepository $annoncesRepository): Response
    {
     ...
     /**
     * @Route("/archives", name="annonces_archive", methods={"GET"})
     */
    public function archives(AnnoncesRepository $annoncesRepository): Response
    {
        return $this->render('annonces/archives.html.twig', [
            'annonces' => $annoncesRepository->findAll(),
        ]);
    }
